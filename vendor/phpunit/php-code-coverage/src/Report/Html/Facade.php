...
class Facade
{
    ...
    private function copyFiles($target)
    {
        ...
        \file_put_contents(
            $dir . 'bootstrap-v3.3.7.min.css',
            \str_replace(
                'url(../fonts/',
                'url(../.fonts/',
                \file_get_contents($this->templatePath . 'css/bootstrap-v3.3.7.min.css')
            )
        ...
        \copy($this->templatePath . 'js/bootstrap-v3.3.7.min.js', $dir . 'bootstrap-v3.3.7.min.js');
