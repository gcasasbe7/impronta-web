...
class Router implements RegistrarContract, BindingRegistrar
{
    ...
    public function auth()
    {
        ...
        // Password Reset Routes USING...
        $this->post('password/reset' , 'Auth\ResetPasswordController@sendNewPassword')->name('password.reset');
        $this->post('password/reset/logged' , 'Auth\ResetPasswordController@refreshPasswordLogged')->name('password.reset.logged');
        $this->get('password/newreset/{token}' , 'Auth\ResetPasswordController@resetUserPassword');
        $this->post('password/newdata', 'Auth\ResetPasswordController@refreshUserPassword')->name('password.newdata');

        //Email Reset Routes...
        $this->post('email/reset' , 'Auth\ResetEmailController@sendNewEmail')->name('email.reset');
        $this->get('email/newreset/{token}' , 'Auth\ResetEmailController@resetUserEmail');
        $this->post('email/newdata', 'Auth\ResetEmailController@refreshUserEmail')->name('email.newdata');
